...
class HeaderWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    _authSocialNetwork.user.image = 'https://freepngimg.com/thumb/mario_bros/92986-mario-play-toy-super-bros-png-file-hd.png';
    ...
    return Container(
      ...
      child: Row(
        children: [
          Expanded(
            child : loadImage(nameAbbreviation, _authSocialNetwork.user.image),
          ),
          Expanded(
            child: Container(
  ...
  Widget loadImage(String nameAbbreviation, String imageUrl) {
    try{
      return Container(
        height: 80.0,
        decoration: BoxDecoration(
